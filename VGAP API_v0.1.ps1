...
###
# Compare the settings from two different games- This can either compare a game to the default values or compare one game to another.
###
Compare-PlanetsSettings -GameID '12345' -GameType 'Standard'
Compare-PlanetsSettings -BasellineGameID '11111' -GameID '12345


###
# Clone-PlanetsGame : In development
###
